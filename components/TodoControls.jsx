      ...
      <div className="relative group">
        <div className="relative group">
          <input
            ...
            className="w-full pl-12 pr-4 py-4 bg-gray-100 dark:bg-gray-800 rounded-[2rem] outline-none shadow-inner border-2 border-gray-200 dark:border-gray-700  focus:border-blue-500 focus:ring-4 ring-blue-500/10 transition-all font-semibold text-slate-900 dark:text-white"
          />
