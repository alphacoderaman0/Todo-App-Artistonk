  ...
  return (
    <form onSubmit={handle} className="relative group">
      <input 
        ...
        className="w-full p-5 pr-24 bg-gray-100 dark:bg-gray-800 rounded-[2rem] outline-none focus:ring-4 ring-blue-500/10 transition-all font-semibold dark:text-white border-2 border-transparent focus:border-blue-500"
      />
