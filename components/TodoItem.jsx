...
export default function TodoItem({ todo }) {
  ...
  return (
    <li className={`flex items-center justify-between p-5 rounded-3xl transition-all duration-300 ${todo.completed ? 'bg-gray-50/50 dark:bg-gray-800/30' : 'bg-white dark:bg-gray-800 shadow-md shadow-blue-500/5'}`}>
